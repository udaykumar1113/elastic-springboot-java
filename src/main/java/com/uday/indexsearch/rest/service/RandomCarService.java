...
import com.uday.indexsearch.rest.domain.Engine;
import com.uday.indexsearch.rest.domain.Tire;
import com.uday.indexsearch.util.RandomDateUtil;
...
public class RandomCarService implements CarService{
    ...
    public Car generateCar() {
        ...
        List randomCompatibleTires = new ArrayList<Tire>();
        for (int i = 0; i < 3; i++) {
